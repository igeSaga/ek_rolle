...
rolle_bld_out_temp<-rolle_bld_out_temp[rolle_bld_out_temp$circularity<0.6,]
...
m <- leaflet() %>%
  ...
  addPolygons(data=rolle_build_osm_excl.wgs,
    ...
    addPolygons(data=rolle_build_av_excl.wgs,
              stroke = TRUE,
              fillOpacity = 0.4, 
              color = "yellow",
              opacity = 1,
...
writeOGR(rolle_bld_out.wgs, "output/geom", "rolle_bld_out.wgs", driver="ESRI Shapefile",overwrite_layer = T)
